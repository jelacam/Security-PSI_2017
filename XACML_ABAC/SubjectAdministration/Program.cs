...
namespace AuthenticationService
{
    public class Program
    {
        private static void Main(string[] args)
        {
            ...
            ServiceHost host = new ServiceHost(typeof(SubjectAdministration));
            host.AddServiceEndpoint(typeof(ISubjectRepository), binding, address);
            ...
            {
                host.Open();
                Console.WriteLine("Subject administration service [Subject repository] is opened. Press <enter> to finish ... ");
                Console.ReadLine();
                host.Close();
            }
            catch (Exception e)
